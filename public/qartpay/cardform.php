    ...
    if($resBonusdetails['error']==0){
        if($resBonusdetails['bonusesCount'] >0){
            ...
            foreach($AvailbonusDetails as $key => $vl){
                ...
                // if($vl['minimum_deposit_amount'] && ($amount >= $vl['minimum_deposit_amount'])){
                ...
                <td>
						...
						<select name="cardExpireYear" id="idyear" class="required" style="" onclick="shownormalborders(this.id);">
                            ...
                            ?>
                                ...
                                <input name="orderAmount" id="idorderAmount" value="<?php echo $amount; ?>" maxlength="6"  class="required" autocomplete="off" onkeyup="enteredAmountValue(<?php echo $_PARAMS['player_id']; ?>)"  onclick="shownormalborders(this.id);" style="width:122px;" type="text">
                    ...
                    <div id="available_coupons"> 
                        ...
                        <select name="availbonusCode" id="availbonusCode">
                            <?php 
                                if(!empty($listofavail)){
