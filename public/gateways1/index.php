...
<script type="text/javascript">
    function loadIframe(type, method, provider){
        $.ajax({
            type:'post',
            url:'request.php',
            data:'cardtype='+type+'&method='+method+'&provider='+provider+'&change=1&id=<?php echo $_PARAMS['id']; ?>&loaded=<?php echo $_PARAMS['has_loaded']+1; ?>',
...
<div style="width:100%;margin-bottom:20px;margin: 0 auto;">
        ...
        <?php for($i=0;$i<count($payment_type);$i++){ ?>
            ...
            <?php foreach($active_methods as $active): ?>
                <?php if($active['payment_type'] == $payment_type[$i]['id']){ ?>
                    <div data-bound="<?php echo strtolower($active['name'])?>" data-id="<?php echo strtolower($active['payment_method_id'])?>" class="cuadro_metodos_boton_seleccion_metodo<?php echo ($_PARAMS['payment_method_id'] == $active['payment_method_id']) ? ' selected_method_btn' : ' unselected_method_btn' ?> featuvisacls" onclick="loadIframe('<?php echo strtolower($active['name'])?>', '<?php echo strtolower($active['payment_method_id'])?>', '<?php echo $active['payment_provider_id']?>');" >
            ...
            <div style="width:100%;">
                ...
                <div style="width:95%;margin:auto;">
                    ...
                    <div class="contenido"<?php echo $styledisplay; ?>>
                        <?php if (is_wap($_PARAMS['web_id'])){ ?>
                        <div id="metolist_detalle_metodos" style="width:98%;margin-right:0px; margin-top:15px; min-height:500px;z-index:999;background: white;">
                            <?php }else{ ?>
                                        ...
                                        <div class="content" style="<?php echo $bar_color;?> /*border: 1px solid #999;*/ padding:0px;">
                                            ...
                                            <div class="title1">
                                                <div class="title" style="    width: 45%;    float: left;">
                                                    ...
                                                    <span id="asterisc" class="rowColoured" style="font-size:13px;">* <?php echo $_FORM_TEXTS['required']; ?></span>
                                                    <br>
                                                </div>
                                                ...
                                                <div class="plogo" >
                                                    ...
                                                    <div class="bimg">
                                                        ...
                                                        if (is_wap($_PARAMS['web_id'])){
                                                            $percentage_width  = 'width="50%"';
															$inlinewidth = ($_PARAMS['payment_method_id'] == 112) ? '25' : '20';
                                                        } else {
                                                            $percentage_width  = 'width="50%"';
															$inlinewidth = ($_PARAMS['payment_method_id'] == 112) ? '40' : '20';
                                                        }
                                            ...
                                            <iframe src="<?php echo $provider_url.'i='.$_REQUEST_ID; ?><?php echo $c; ?><?php echo $vt; ?><?php echo $bill; ?>" style="border: 1px; padding:0px; width:100%; height:712px;"></iframe>
                                        </div>
