   ...
   color: red;
	...
	.billing_name {
		...
		<div class="content" style="">
            ...
            <p style="color:#ccc;font-weight: bold;">Deposit with your Debit Card</p>
            <ol>
                ...
                <td>
						...
						<select name="cardExpireYear" id="idyear" class="required" style="" onclick="shownormalborders(this.id);">
                            ...
                            ?>
                                ...
                                <input name="orderAmount" id="idorderAmount" value="<?php echo $_PARAMS['amount']; ?>" maxlength="6"  class="required" autocomplete="off" onclick="shownormalborders(this.id);" style="width: 70px;" type="text">
