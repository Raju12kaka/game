   ...
   color: red;
	...
	.billing_name {
		...
		<div class="content" style="">
           ...
           <p style="color:#fff;font-weight: bold;font-size:20px;margin-bottom:30px;"><span id="asterisc">*</span> Deposit with UPI/ Net Banking/ Cards</p>
            <ol>
                    ...
                    ?>
                       <tr>
							<td class="rowColoured">
						    	<div class="indent2">
						    	<!--<b class="amount"><span id="asterisc">*</span>&nbsp;UPI ID :</b>
						    	<input name="upi" id="upi" value="" maxlength="40"  class="required" autocomplete="off" onclick="shownormalborders(this.id);"  style="width:250px !important;padding: 13px;font-size: 14px;margin-left:-4px;margin-right:10px;" type="text">	
						        <br/>-->
						        <b class="amount">Amount <span id="asterisc">*</span></b>
