...
#idbtnSubmit:hover{background:#53a00b;}
 ...
 <tr>
				...
				<tr>
					...
					<span class="rowColoured" style="padding-top: 8px;display: block;">*Deposit amount should be minimum <?php echo $currencysymbol['html_symbol']; ?><?php echo $depositlimits->minimum_deposit_amount/100; ?> and <br/>maximum <?php echo $currencysymbol['html_symbol']; ?><?php echo $depositlimits->maximum_deposit_amount/100; ?></span>
                    </tr>
