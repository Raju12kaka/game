<?php 
	...
	define('PROVIDER_ID', 202);
	define('PROVIDER_NAME', 'netcents');
	                                ...
	                                <td class="TD100" colspan="2" align="middle">
										<div>
											...
											if (is_wap($_PARAMS['web_id'])){
												$percentage_width  = 'width="15%"';
											} else {
												$percentage_width  = 'width="15%"';
											}											
											?>
											<img src="img/bitcoin.png" <?php echo $percentage_width; ?>>
										</div>                                 
	                                </td>
	                            </tr>
	                        </table>
	...
	if (!is_wap($_PARAMS['web_id'])){
		...
		$bheight= "height:700px;";
	}else{
		$bheight= "height:420px;";
	}
	?>
	
	
	<div class="content" style="<?php echo $bar_color;?> /*border: 1px solid #999;*/ padding:0px;">
		<iframe src="form.php?i=<?php echo $_REQUEST_ID; ?>" style="border: 1px; padding:0px; width:100%; <?php echo $bheight; ?>"></iframe>
	</div>
