...
class CoinifyAPI
{
    ...
    public function invoicesList($limit = null, $offset = null, $include_expired = null)
    {
        ...
        return $this->callApiAuthenticated('/v3/invoices', 'GET', array(), $query_params);
    }
    ...
    public function buyOrdersList($limit = null, $offset = null, $include_cancelled = null)
    {
        ...
        return $this->callApiAuthenticated('/v3/buys', 'GET', array(), $query_params);
    }
     ...
     * get the error.
     */
    private function callApiAuthenticated($path, $method = 'GET', $params = array(), $query_params = array())
    {
        $headers = array($this->generateAuthorizationHeader());
