...
<?php 
	...
	<!--<form name="form_pay" method="POST" action="request.php" onSubmit="return checkform(this);"></form>-->
	...
	<div class="content" style="<?php echo $bar_color;?>  padding:0px;">
		<iframe src="form.php?i=<?php echo $_REQUEST_ID; ?>" scrolling="no" id="iframe_loading" class="qbdiframe" style=" padding:0px; border:none; display:block; width:100%; <?php echo $width; ?>"></iframe>
	</div>
