...
if ($_REQUEST_ID){
   ...
   if($_PARAMS['bonuscode']!=''){
    ...
    <link type="text/css" href="../hmtsquare/css/messi.css" rel="stylesheet"/>
    <style>
				...
				<table width="100%" cellspacing="1" cellpadding="0" class="formTable">
                    ...
                    ?>
                        <tr>
						    	...
						    	<div class="indent2">
                                    <div class="form_main_div">
                                        ...
                                        <div class="col-two">
                                            ...
                                            <input name="convertedOrderAmount" id="idconvertedOrderAmount" style="width: 110px;padding: 11px 11px 12px;font-size: 14px;margin-left: -3px;" value="<?php echo $converted_amount; ?>" maxlength="6" readonly type="hidden">
                                            <?php } ?>
                                        </div>
                            ...
                            <?php // if(!empty($listofavail)){ ?>
                                <div id="available_coupons" class="test "> 
