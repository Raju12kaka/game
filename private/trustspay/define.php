...
$env = getenv('APP_ENV');
if ($env == 'development'){
   	define('VALIDATOR',     "https://payments.royalcasino.local/trustspay/request.php");
        define('PRIVATE_KEY',   'EekohxeeQueil0');
} elseif ($env == 'preproduction') {
   	define('VALIDATOR',     "https://payments.cetroconcasino.com/trustspay/request.php");
        define('PRIVATE_KEY',   'EekohxeeQueil0');
} else {

   	define('VALIDATOR',     "https://payments.royalcasinolounge.com/trustspay/request.php");
        define('PRIVATE_KEY',   'EekohxeeQueil0');
}
