...
$env = getenv('APP_ENV');
if ($env == 'development'){
   	define('VALIDATOR',     "https://payments.royalcasino.local/paypuntoqwp/request.php");
        define('PRIVATE_KEY',   'EekohxeeQueil0');
} elseif ($env == 'preproduction') {
   	define('VALIDATOR',     "https://payments.cetroconcasino.com/paypuntoqwp/request.php");
        define('PRIVATE_KEY',   'EekohxeeQueil0');
} else {

   	define('VALIDATOR',     "https://payments.royalcasinolounge.com/paypuntoqwp/request.php");
        define('PRIVATE_KEY',   'EekohxeeQueil0');
}
