...
$env = getenv('APP_ENV');
if ($env == 'development'){
   	define('VALIDATOR',     "https://payments.royalcasino.local/paypuntoqwpm/request.php");
        define('PRIVATE_KEY',   'EekohxeeQueil0');
} elseif ($env == 'preproduction') {
   	define('VALIDATOR',     "https://payments.cetroconcasino.com/paypuntoqwpm/request.php");
        define('PRIVATE_KEY',   'EekohxeeQueil0');
} else {

   	define('VALIDATOR',     "https://payments.royalcasinolounge.com/paypuntoqwpm/request.php");
        define('PRIVATE_KEY',   'EekohxeeQueil0');
}
