...
$env = getenv('APP_ENV');
if ($env == 'development'){
	define('VALIDATOR', 	"https://payments.royalcasino.local/dummy/request.php");
	define('PRIVATE_KEY', 	'EekohxeeQueil0');
} elseif ($env == 'preproduction') {
    define('VALIDATOR',     "https://payments.cetroconcasino.com/dummy/request.php");
    define('PRIVATE_KEY',   'Owah6phuehufur');
}else {
	define('VALIDATOR', 	"https://payments.royalcasinolounge.com/dummy/request.php");
	define('PRIVATE_KEY', 	'Owah6phuehufur');
}
